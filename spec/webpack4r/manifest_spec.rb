...
require 'spec_helper'
require 'webpack4r/manifest'
require 'pathname'

RSpec.describe Webpack4r::Manifest do
  describe '.new' do
  ...
  describe '#lookup_pack_with_chunks!' do
    ...
    context 'when non exist name is given' do
      ...
      it { expect { subject }.to raise_error Webpack4r::Manifest::MissingEntryError }
    end
  end
  ...
  describe '#load_data' do
    ...
    context 'when non-existing manifest is given' do
      ...
      it { expect { subject }.to raise_error Webpack4r::Manifest::FileNotFoundError }
    end
  end
end
